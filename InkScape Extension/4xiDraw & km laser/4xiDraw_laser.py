...
class laser_gcode(inkex.Effect):
    ...
    def export_gcode(self,gcode):
        ...
        f.write(self.options.laser_off_command + " S" + "0" + "\n" + self.header + "G1 F" + self.options.travel_speed + "\n" + gcode + self.footer)
        f.close()
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("",   "--laser-command",                   action="store", type="string",          dest="laser_command",                       default="M05",                          help="Laser gcode command")
        self.OptionParser.add_option("",   "--laser-off-command",               action="store", type="string",          dest="laser_off_command",                   default="M03",                          help="Laser gcode end command")
        self.OptionParser.add_option("",   "--laser-speed",                     action="store", type="int",             dest="laser_speed",                         default="5000",                         help="Laser speed (mm/min)")
        ...
        self.OptionParser.add_option("",   "--power-delay",                     action="store", type="string",          dest="power_delay",                         default="0.2",                          help="Laser power-on delay (ms)")
...
################################################################################
    def effect(self) :
        ...
        self.tools = {
            ...
            "gcode before path": ("G4 P" + self.options.power_delay + "\n" + self.options.laser_command + " S" + str(int(self.options.laser_power)) + "\nG4 P" + self.options.power_delay),
            "gcode after path": ("G4 P" + self.options.power_delay + "\n" + self.options.laser_off_command + " S" + "0" + "\n" + "G4 P" + self.options.power_delay + "\n" + "G1 F" + self.options.travel_speed),
        }
